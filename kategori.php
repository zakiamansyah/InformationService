    ...
    <div class="container">
      <div class="row">
          ...
          error_reporting(0);
                  ...
                  $sql = mysql_query("SELECT produk.*,tipe_produk.nama_tipe FROM produk,tipe_produk WHERE produk.id_tipe=tipe_produk.id_tipe AND produk.id_tipe='$id' LIMIT $mulai, $halaman");
                  $no = $mulai+1;
                  while ($row = mysql_fetch_array($sql)) {
                  	if (empty($id)) {
                  	header('location:index.php');
                  }elseif ($row[id_tipe] != $id) {
                  	header('location:index.php');
                  }
          ?>
          ...
          <br><br>
            ...
            <nav aria-label="paging">
              <ul class="pagination">
                ...
                <li class="page-item">
                  <a class="page-link" href="kategori.php?page=<?=$link_prev?>" tabindex="-1">
                ...
                <?php
                  ...
                  ?>
                    <li class="page-item <?php echo $link_active; ?>"><a class="page-link" href="kategori.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                  <?php
                  }
                  ?>
                ...
                <li class="page-item">
                  <a class="page-link" href="kategori.php?page=<?php echo $link_next; ?>">
