        ...
        <div class="col-md-2">
                ...
                <ul class="nav">
                    ...
                    <li class="submenu current">
                         ...
                         <ul>
                            ...
                            <li class="current"><a href="penjualan.php">Penjualan</a></li>
                        </ul>
                    </li>
                </ul>
             </div>
		  ...
		  <div class="col-md-10">
		  	<div class="content-box-header success">
			  	<div class="panel-title" style="color: #fff;">Penjualan</div>		
			</div>
				<div class="content-box-large box-with-header">
          <a href="cetakjual.php" class="btn btn-primary btn-sm" target="_blank"><i class="fa fa-print"></i> Cetak</a>
				<table class="table" id="tablebr">
                  ...
                  $total = 0;
                    ...
                    $cekstok = mysql_query("SELECT sum(jumlah_produk) as stok FROM order_items WHERE id_produk='$row[id_produk]'");
                    $stok = mysql_fetch_array($cekstok);
                    $subtotal = $row['harga']*$stok['stok'];
              			echo '
              			<tr>
              				<td>'.$no.'</td>
              				<td>'.$row[id_produk].'</td>
